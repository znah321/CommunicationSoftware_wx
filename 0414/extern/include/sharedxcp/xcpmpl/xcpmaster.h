...
XCPAPI void              xcpmWriteMeasurement(HMSR h, void* in, int  in_dtid);

XCPAPI void              xcpmReadMeasurement(HMSR h, void* out, int out_dtid);
